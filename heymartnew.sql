...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Nov 2018 pada 17.24
...
-- Prosedur
--
CREATE DEFINER=`root`@`localhost:8080` PROCEDURE `SPGetUserData` (IN `id_in` VARCHAR(5))  NO SQL
BEGIN
...
(6, 'bernand', 'mail.bernand@gmail.com', '$2y$12$pPVHEWyE7WdAFyd.XumcweRz.iXdFeeBHhWQemT/OU7bXmhvmSb7i', 'GPMSEo3yU3Yz5ddptz2CNTr3ZDywSrFTYQsx19oap35wTph8R1Z0D28OYe1n', NULL, NULL, '', 1);
...
--
ALTER TABLE `penjualan`
  MODIFY `id_penjualan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
